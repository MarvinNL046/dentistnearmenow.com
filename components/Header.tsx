  ...
  return (
    ...
    >
      ...
      <div className="bg-red-600 text-white py-2">
        <div className="container mx-auto px-4 flex justify-center items-center gap-2 text-sm">
          <AlertCircle className="w-4 h-4" />
          <span>Dental Emergency?</span>
          <Link href="/emergency-dentist" className="font-semibold underline hover:no-underline">
        ...
        {isMenuOpen && (
          <div className="lg:hidden mt-4 pb-4 border-t pt-4">
            ...
            <div className="mt-4 pt-4 border-t space-y-2">
              <Link href="/emergency-dentist" onClick={() => setIsMenuOpen(false)}>
